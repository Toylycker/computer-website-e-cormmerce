@extends('layouts.app')
@section('title') @lang('app.computer') - @lang('app.create') @endsection
@section('content')
    <div class="container-xxl py-3">
        <div class="d-block h4 text-danger text-center border-bottom py-2 mb-3">
            @lang('app.computer') - @lang('app.create')
        </div>
        <div class="row justify-content-center">
            <form action="{{ route('computer.store') }}" method="post" enctype="multipart/form-data" class="col-md-6 col-lg-4">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('model_number') is-invalid @enderror" name="model_number" id="model_number" value="{{ old('model_number') }}" maxlength="255" required>
                    @error('model_number')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('serial_number') is-invalid @enderror" name="serial_number" id="serial_number" value="{{ old('serial_number') }}" maxlength="255" required>
                    @error('serial_number')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('stock') is-invalid @enderror" name="stock" id="stock" value="0" min="0" required>
                    @error('stock')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('discount_percent') is-invalid @enderror" name="discount_percent" id="discount_percent" value="0" min="0" required>
